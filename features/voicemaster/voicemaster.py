...
class VoiceMaster(Cog):
    ...
    def __init__(self, bot: pumpumpal):
    ...
    async def voicemaster_setup(self, ctx: Context):
        ...
        embed.add_field(
            name="**Button Usage**",
            value=(
                f"{config.Emoji.Interface.lock} — [`Lock`](https://discord.gg/pFK6erfxCp) the voice channel\n"
                f"{config.Emoji.Interface.unlock} — [`Unlock`](https://discord.gg/pFK6erfxCp) the voice channel\n"
                f"{config.Emoji.Interface.ghost} — [`Ghost`](https://discord.gg/pFK6erfxCp) the voice channel\n"
                f"{config.Emoji.Interface.reveal} — [`Reveal`](https://discord.gg/pFK6erfxCp) the voice channel\n"
                f"{config.Emoji.Interface.claim} — [`Claim`](https://discord.gg/pFK6erfxCp) the voice channel\n"
                f"{config.Emoji.Interface.disconnect} — [`Disconnect`](https://discord.gg/pFK6erfxCp) a member\n"
                f"{config.Emoji.Interface.activity} — [`Start`](https://discord.gg/pFK6erfxCp) a new voice channel activity\n"
                f"{config.Emoji.Interface.information} — [`View`](https://discord.gg/pFK6erfxCp) channel information\n"
                f"{config.Emoji.Interface.increase} — [`Increase`](https://discord.gg/pFK6erfxCp) the user limit\n"
                f"{config.Emoji.Interface.decrease} — [`Decrease`](https://discord.gg/pFK6erfxCp) the user limit\n"
            ),
        )
